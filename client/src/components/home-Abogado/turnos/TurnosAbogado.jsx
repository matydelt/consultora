...
export default function TurnosAbogado() {
  ...
  function eliminarDia(dia) {
    swal({
      ...
      .catch((err) =>
        toast.error("Ocurrió un problema al eliminar el día y sus turnos")
      );
  }
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <textarea
                  ...
                  placeholder="La nota se guardará en todos los días seleccionados"
                />
        ...
        <div className="row align-middle my-3">
          ...
          <div className="col-auto text-right align-middle ">
            <select
              ...
              title={
                "Los meses corresponden al año corriente. \nLos turnos de otros años se encuentran en 'Ver todos los turnos'."
              }
            >
              <option selected={mesActual === -1} value="">
                ...
                return (
                  ...
                  >
                    <td className="text-capitalize">
                      {new Date(dia.fecha).toLocaleDateString("es-ES", options)}
                    </td>
