...
import { getUsuarios, setAbogado, setAdmin, setBann } from "../../redux/actions";
...
export default function AdminPage() {
    ...
    const hadleChange = (e, type) => {
        ...
        if (type === "abogado") {
            ...
            if (aux.adminId !== 1) {
                ...
                var wrapper = document.createElement('div')
                wrapper.innerHTML = '<div class="alert alert-' + type + ' alert-dismissible" role="alert">' + mensaje
    ...
    const reiniciarContraseña = async (email) => {
        ...
        // await updatePassword(email, 'asdsadsad')
                        ...
                        {allUsers?.map((e, i) => {
                            ...
                            return (
                                <tr key={i}>
                                    ...
                                    {/* <td>
                                        <button onClick={() => reiniciarContraseña(e.eMail)} className="btn btn-warning">Reiniciar contraseña</button>
                                    </td> */}
                                    <td>{e.eMail}</td>
                                    <td>{e.personaDni} </td>
                                </tr>
