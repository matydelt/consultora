...
const sequelize = new Sequelize(`${DB_SERVER}://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/${DB_NAME}`, {
...
const { Persona, Cliente, Usuario, Abogado, Materias, Casos, Matricula, Provincias } = sequelize.models;
